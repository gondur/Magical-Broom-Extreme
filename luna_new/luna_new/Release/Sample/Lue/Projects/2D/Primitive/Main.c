...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdPoint, int nCmdShow )
{
	...
	while ( Lue_Run( LFALSE ) )
	{
		...
		// プリミティブバッファの内容を画面に描画
		LuePrimitive2D_Rendering( hPrimitive );
