...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
	...
	if ( pCore->Initialize( L"Selene Sample Program", FRAME_RATE_60 ) )
	{
		...
		//-----------------------------------------------------------------
		// 3Dポイントプリミティブを生成
		//   IPointPrimitive3Dは最も低レベルならインターフェイスです。
		pPoint = pRender->CreatePointPrimitive3D( 10000, false );
		...
		// 箱内にランダムな点
		{
			...
			{
				SVertex3DBase Pt;
				Pt.Pos.x = Rand.GetFloat( -10.0f, +10.0f );
				Pt.Pos.y = Rand.GetFloat( -10.0f, +10.0f );
				Pt.Pos.z = Rand.GetFloat( -10.0f, +10.0f );
				Pt.Col = 0xFFFFFFFF;
				pPoint->Push( &Pt, 1 );
			}
		}
