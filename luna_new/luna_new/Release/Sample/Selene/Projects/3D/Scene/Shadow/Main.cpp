...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
	...
	if ( pCore->Initialize( L"Selene Sample Program", FRAME_RATE_60 ) )
	{
		...
		pSceneMgr = pRender->CreateSceneManager( SCENE_MODE_MANAGED, SCENE_MODE_OPTION_SHADOW );
		...
		pModel = pRender->CreateModelFromFile( L"ball.smf" );
		...
		while ( pCore->Run() )
		{
			...
			//   CStyleクラスで変換をかけたものを
			//   カメラに渡します。
			CVector3D vEye( 0.0f, 20.0f, -30.0f );
			CVector3D vAt( 0.0f, 5.0f, 0.0f );
			...
			CVector3D vColSky( 0.4f, 0.4f, 0.5f );
			CVector3D vColEarth( 0.3f, 0.2f, 0.2f );
			...
			pSceneMgr->SetShadowLight(
				CVector3D( 10.0f, 50.0f, 0.0f ),	// カメラ位置
				CVector3D( 0.0f, 0.0f, 0.0f ),		// カメラ注視点
				100.0f,								// レンダリングサイズ
				30.0f,								// 近クリップ面
				60.0f,								// 遠クリップ面
				0.01f );							// Z値バイアス（実際に見ていい感じに調整
			...
			Style.TransformReset();
			Style.Translation( 0.0f, 10.0f, 0.0f );
			Style.RotationX( pCore->GetSyncCount() * 128 );
